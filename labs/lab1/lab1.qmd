...
The design met all intended design objectives. Figure 3, 4, and 5 show screenshots of the QuestaSim simulation of the testbenches designed for each module. Figures 6, 7, and 8 below show screenshots of the terminal output of the testbench modules, confirming zero errors and successful simulation.
One note--- since the 2.4 Hz blinking LED is difficult to test for in the testbench, it was forced to 0 through the command `force led[2] 0` before running the testbench.

![Figure 6](images/lab1-mt-test-output.png)

![Figure 7](images/leds-test-output.png)

![Figure 8](images/sev-seg-test-output.png)

### Oscilloscope Trace

![Figure 9](images/oscope-trace.png)
...
![Figure 10](images/lab1-ai-error.png)
